...
public enum SysMessageDataSourceClassEnum {
    /***/
    COOPERATION(1, "城市创新合作清单"),
    DEVELOPING(2, "企业创新发展清单"),
    TARGET(3, "成长目标投资清单"),
    DEMAND(4, "高端才智需求清单"),
    SUGGEST(5, "意见和建议"),
    ...
    HELP(10, "清单协同处理"),
    COOPERATION_RELEASE(20, "城市创新合作清单发布管理"),
    DEVELOPING_RELEASE(21, "企业创新发展清单发布管理"),
    TARGET_RELEASE(22, "成长目标投资清单发布管理"),
    DEMAND_RELEASE(23, "高端才智需求清单发布管理"),
