...
public class IplDarbMainController extends BaseWebController {
    ...
    private void adapterField(Map<String, Object> m, IplDarbMain entity, Map<Long, Object> collect) {
        ...
        m.put("industryCategory", entity.getIndustryCategory());
        m.put("industryCategoryName", collect.get(entity.getIndustryCategory()));
        m.put("demandItem", entity.getDemandItem());
        ...
        m.put("sourceName", SourceEnum.ENTERPRISE.getId().equals(entity.getSource()) ? "企业" : InnovationUtil.getDeptNameById(entity.getIdRbacDepartmentDuty()));
