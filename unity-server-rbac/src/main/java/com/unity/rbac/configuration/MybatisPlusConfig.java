...
//    @Bean
//    public SelectCountInjector selectCountInjector() {
...
//        return new LogicSqlInjector();
     ...
     * @return
     */
    @Profile("devel")// 设置 test 环境开启
    @Bean
    public PerformanceInterceptor performanceInterceptorDevel() {
    ...
    @Bean
    public PerformanceInterceptor performanceInterceptorTest() {
        return new PerformanceInterceptor();
    }
    /**
     * 乐观锁插件
